...
en [console.groq.com/keys](https://console.groq.com/keys), "Create API
Key". Toma menos de dos minutos, dentro de los 15 de la compuerta G2. (No
se incluye una key en este repositorio a propósito: GitHub bloquea por
diseño cualquier push que contenga una API key real, y aunque se
autorizara el bypass, quedaría expuesta en el historial de git para
siempre — un repositorio público no es el lugar para una credencial, ni
siquiera "temporal".)
